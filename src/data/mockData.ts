...
export const articles = [
  ...
  {
    id: 6,
    title: "Bitcoin Crosses $100K — What It Means For You",
    category: "Crypto",
    readTime: "5 min",
    featured: false,
    image: "₿",
  ...
  {
    id: 7,
    title: "5 Smart Tax-Saving Investments for 2026",
    category: "Tax Tips",
    readTime: "4 min",
    featured: false,
    image: "🏛️",
  ...
  {
    id: 8,
    title: "How to Build a ₹10 Lakh Emergency Fund",
    category: "Savings",
    readTime: "6 min",
    featured: false,
    image: "🏗️",
...
export const learnTopics = [
  { id: 1, title: "What is SIP?", subtitle: "Learn systematic investment plans", emoji: "📈", color: "hsl(245 58% 51%)", progress: 75 },
  { id: 2, title: "Emergency Fund 101", subtitle: "Building your safety net", emoji: "🏦", color: "hsl(152 60% 42%)", progress: 30 },
  { id: 3, title: "Credit Score Basics", subtitle: "Understanding CIBIL scores", emoji: "💳", color: "hsl(38 92% 50%)", progress: 0 },
  { id: 4, title: "Budgeting Made Easy", subtitle: "Master the 50/30/20 rule", emoji: "📋", color: "hsl(280 60% 55%)", progress: 100 },
];
